...
function Navbar() {
  ...
  return (
    <motion.nav 
      ...
      className="backdrop-blur-sm shadow-lg fixed w-full z-50 border-b border-blue-700 border-opacity-30 drop-shadow-2xl"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`flex items-center h-14 ${isMobile ? 'justify-center' : 'justify-between'}`}>
          <div className={`flex items-center ${isMobile ? 'absolute left-4' : ''}`}>
            ...
            >
              <img className="h-8 w-8 drop-shadow-lg" src={logo} alt="Logo" />
            </motion.button>
          </div>
